        ...
        <script>
            ...
            var clusterCounts = {!! json_encode($formattedClusterCounts) !!};
            ...
            option = {
                ...
                legend: {
                    ...
                    left: 'center',
                    textStyle: {
                        fontSize: 12, // Ukuran font untuk judul legenda
                ...
                series: [{
                    ...
                    type: 'pie',
                    radius: '50%',
                    // top: '10px', // Menambahkan margin top untuk pie chart
                    // bottom: '30px', // Menambahkan margin top untuk pie chart
        ...
        <script>
            ...
            // Ambil data dari variabel PHP dan konversi menjadi format JavaScript
            var rumpunData = {!! json_encode($formattedRumpunData) !!};
