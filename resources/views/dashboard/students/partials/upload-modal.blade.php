<div id="UploadModal"
    class="fixed z-20 right-0 inset-0 bg-black bg-opacity-50 flex justify-center items-center shadow-lg shadow-black hidden opacity-0 transition-opacity duration-300">
    <div
