...
@section('title', 'Nilai | Detail Nilai')
@section('container')

    {{-- ini adalah bagian Header Value Page - DETAIL VALUE --}}
    <div class="pb-2 mb-9 border-b border-secondary flex flex-row justify-between items-end">
        <h1 class="font-semibold text-slate-700 text-3xl">Detail Nilai
        </h1>
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="/dashboard/values"
                            class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2">Nilai</a>
                    </div>
                </li>
                <li>
                    <div class="flex items-center">
                        ...
                        <a
                            class="cursor-default ms-1 text-sm font-medium {{ Request::is('dashboard/values/*') ? 'text-blue-600' : '' }} hover:text-blue-600 md:ms-2">Detail
                            Nilai</a>
                    </div>
                </li>
        ...
        <div class="relative overflow-hidden mb-4 flex flex-row bg-white rounded-lg shadow">
            ...
            <div class="flex flex-col py-5 px-5 w-full">
                ...
                <div class="flex flex-row gap-4 mt-5">
                    ...
                    <a href="/dashboard/values/{{ $student->id }}/edit"
